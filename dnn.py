...
from scikeras.wrappers import KerasClassifier  # 替换为 scikeras
...
for fp in df:
    ...
    y_pred_prob = best_dnn_model.predict_proba(X_test)[:, 1]
...
evaluation_results.to_csv('DNNclaresults_ba.csv', index=False)
