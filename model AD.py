...
# 创建和训练模型
Best_para = {'num_leaves': 30, 'n_estimators': 1000, 'min_child_samples': 10, 'learning_rate': 0.05, 'lambda_l2': 0.5, 'lambda_l1': 0.5}



#svr = SVR(**Best_para)#SVM模型需要特征标准化
#svr.fit(X_train, y_train)
#gbdt = GradientBoostingRegressor(**Best_para)
#gbdt.fit(X_train, y_train)LGBMRegressor(**Best_para)
best_model = LGBMRegressor(**Best_para)
